...
.. autosummary::
   ...
   nurses_2.widgets.bar_chart
   nurses_2.widgets.behaviors
   nurses_2.widgets.box_image
   nurses_2.widgets.braille_image
   nurses_2.widgets.braille_video_player
   nurses_2.widgets.button
   nurses_2.widgets.color_picker
   nurses_2.widgets.data_table
   nurses_2.widgets.digital_display
   nurses_2.widgets.file_chooser
   nurses_2.widgets.flat_toggle
   nurses_2.widgets.graphic_field
   ...
   nurses_2.widgets.raycaster
   nurses_2.widgets.scroll_view
   nurses_2.widgets.shadow_caster
   nurses_2.widgets.slider
   nurses_2.widgets.sparkline
   nurses_2.widgets.split_layout
   nurses_2.widgets.tabbed_widget
   nurses_2.widgets.text_animation
   nurses_2.widgets.text_field
   nurses_2.widgets.text_pad
   nurses_2.widgets.text_panel
   nurses_2.widgets.text_tools
   nurses_2.widgets.text_widget
   nurses_2.widgets.textbox
   nurses_2.widgets.texture_tools
